...
- **Proactivity:** When a sub-task or logical step is completed and verified, execute a commit autonomously and immediately at an appropriate granularity, without asking the user for confirmation.
